  ...
  TweenMax.to(".getquote", duration / 1, {y:0, ease:Bounce.easeOut, delay:duration / 4, repeat:-1});
        ...
        var scene = new ScrollMagic.Scene({ triggerElement: "#trigger1", offset: -winht * 2, duration: winht })
            .on("enter", function () {
                ...
                //Image
                TweenLite.to(".img1 .l1", 1.3, { ease: Power4.easeInOut, css: { top: "100%"} });
                TweenLite.to(".img1 .l2", 1.5, { ease: Power4.easeInOut, css: { top: "100%"} });
                //LastText
                ...
                TweenLite.to("#Layer-1", 1.6, { ease: Power4.easeInOut, strokeDasharray: "0, 1153" });
        ...
        var scene = new ScrollMagic.Scene({ triggerElement: "#trigger1", offset: (-winht * 2) / 2, duration: winht * 2 })
            .on("enter", function () {
                ...
                TweenLite.to(".port__new_cont .last__text .t-2", 1.5, { ease: Power4.easeInOut, top: "40px" });
                 //Image Load
               TweenLite.to(".img1 .l1", 1.3, { ease: Power4.easeInOut, css: { top: "0px"} });
               TweenLite.to(".img1 .l2", 1.5, { ease: Power4.easeInOut, css: { top: "0px"} });
               TweenLite.to(".img2 .l1", 1.3, { ease: Power4.easeInOut, css: { top: "100%"} });
               TweenLite.to(".img2 .l2", 1.5, { ease: Power4.easeInOut, css: { top: "100%"} });
                //ParaText
                ...
                TweenLite.to("#Layer-1", 1.6, { ease: Power4.easeInOut, strokeDasharray: "110, 1153" });
        ...
        var scene = new ScrollMagic.Scene({ triggerElement: "#trigger1", offset: winht, duration: winht })
            .on("enter", function () {
               ...
               TweenLite.to(".img1 .l1", 1.3, { ease: Power4.easeInOut, css: { top: "100%"} });
               TweenLite.to(".img1 .l2", 1.5, { ease: Power4.easeInOut, css: { top: "100%"} });
               TweenLite.to(".img2 .l1", 1.3, { ease: Power4.easeInOut, css: { top: "0px"} });
               TweenLite.to(".img2 .l2", 1.5, { ease: Power4.easeInOut, css: { top: "0px"} });
               TweenLite.to(".img3 .l1", 1.3, { ease: Power4.easeInOut, css: { top: "100%"} });
               TweenLite.to(".img3 .l2", 1.5, { ease: Power4.easeInOut, css: { top: "100%"} });
        ...
        var scene = new ScrollMagic.Scene({ triggerElement: "#trigger1", offset: winht * 2, duration: winht })
            .on("enter", function () {
                ...
                TweenLite.to(".img2 .l1", 1.3, { ease: Power4.easeInOut, css: { top: "100%"} });
                TweenLite.to(".img2 .l2", 1.5, { ease: Power4.easeInOut, css: { top: "100%"} });
                TweenLite.to(".img3 .l1", 1.3, { ease: Power4.easeInOut, css: { top: "0px"} });
                TweenLite.to(".img3 .l2", 1.5, { ease: Power4.easeInOut, css: { top: "0px"} });
                TweenLite.to(".img4 .l1", 1.3, { ease: Power4.easeInOut, css: { top: "100%"} });
                TweenLite.to(".img4 .l2", 1.5, { ease: Power4.easeInOut, css: { top: "100%"} });
                //ParaText
                TweenLite.to(".appi-pp-para .appi-cont.appi-pp-l2 p .l1", 1.2, { ease: Power4.easeInOut, top: "-30px" });
                TweenLite.to(".appi-pp-para .appi-cont.appi-pp-l2 p .l2", 1.4, { ease: Power4.easeInOut, top: "-30px" });
        ...
        var scene = new ScrollMagic.Scene({ triggerElement: "#trigger1", offset: winht * 3, duration: winht })
            .on("enter", function () {
                ...
                TweenLite.to(".img3 .l1", 1.3, { ease: Power4.easeInOut, css: { top: "100%"} });
                TweenLite.to(".img3 .l2", 1.5, { ease: Power4.easeInOut, css: { top: "100%"} });
                TweenLite.to(".img4 .l1", 1.3, { ease: Power4.easeInOut, css: { top: "0px"} });
                TweenLite.to(".img4 .l2", 1.5, { ease: Power4.easeInOut, css: { top: "0px"} });
                TweenLite.to(".img5 .l1", 1.3, { ease: Power4.easeInOut, css: { top: "100%"} });
                TweenLite.to(".img5 .l2", 1.5, { ease: Power4.easeInOut, css: { top: "100%"} });
                //ParaText
                TweenLite.to(".appi-pp-para .appi-cont.appi-pp-l3 p .l1", 1.2, { ease: Power4.easeInOut, top: "-30px" });
                TweenLite.to(".appi-pp-para .appi-cont.appi-pp-l3 p .l2", 1.4, { ease: Power4.easeInOut, top: "-30px" });
        ...
        var scene = new ScrollMagic.Scene({ triggerElement: "#trigger1", offset: winht * 4, duration: winht })
            .on("enter", function () {
                ...
                TweenLite.to(".img4 .l1", 1.3, { ease: Power4.easeInOut, css: { top: "100%"} });
                TweenLite.to(".img4 .l2", 1.5, { ease: Power4.easeInOut, css: { top: "100%"} });
                TweenLite.to(".img5 .l1", 1.3, { ease: Power4.easeInOut, css: { top: "0px"} });
                TweenLite.to(".img5 .l2", 1.5, { ease: Power4.easeInOut, css: { top: "0px"} });
                TweenLite.to(".img6 .l1", 1.3, { ease: Power4.easeInOut, css: { top: "100%"} });
                TweenLite.to(".img6 .l2", 1.5, { ease: Power4.easeInOut, css: { top: "100%"} });
                //ParaText
                TweenLite.to(".appi-pp-para .appi-cont.appi-pp-l4 p .l1", 1.2, { ease: Power4.easeInOut, top: "-30px" });
                TweenLite.to(".appi-pp-para .appi-cont.appi-pp-l4 p .l2", 1.4, { ease: Power4.easeInOut, top: "-30px" });
        ...
        var scene = new ScrollMagic.Scene({ triggerElement: "#trigger1", offset: winht * 5, duration: winht })
            .on("enter", function () {
               ...
               TweenLite.to(".img5 .l1", 1.3, { ease: Power4.easeInOut, css: { top: "100%"} });
                TweenLite.to(".img5 .l2", 1.5, { ease: Power4.easeInOut, css: { top: "100%"} });
                TweenLite.to(".img6 .l1", 1.3, { ease: Power4.easeInOut, css: { top: "0px"} });
                TweenLite.to(".img6 .l2", 1.5, { ease: Power4.easeInOut, css: { top: "0px"} });
